...
//
// Usage:
//   static MemoryEditor memoryEditor;                                            // store your state somewhere
//   memoryEditor.DrawWindow("Memory Editor", mem_block, mem_block_size, 0x0000); // create a window and draw memory editor (if you already have a window, use DrawContents())
//
// Usage:
